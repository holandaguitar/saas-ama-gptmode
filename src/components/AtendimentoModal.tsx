...
export function AtendimentoModal({ triggerLabel, onSubmit, initialData }: Props) {
  ...
  function validate(): boolean {
    const required: Record<string, string> = { "associado_id": "", "descricao": "", "data": "", "responsavel": "" };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border rounded p-2 w-full focus:outline-none focus:ring focus:ring-primary/30"
            />
            {errors["responsavel"] && <span className="text-red-500 text-xs">{errors["responsavel"]}</span>}
          </div>
